	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				names: ["slug"],
				types: [null],
				load: () => import('./entries/endpoints/_slug_.json.js')
			},
			{
				type: 'page',
				id: "[slug]",
