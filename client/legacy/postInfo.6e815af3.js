import { _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, c as _getPrototypeOf, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, f as _createClass, S as SvelteComponentDev, g as getPostDate, h as getDefaultAuthor, j as element, t as text, k as claim_element, l as children, m as claim_text, n as detach_dev, o as attr_dev, p as add_location, q as insert_dev, r as append_dev, u as noop, v as empty, w as destroy_each, x as space, y as claim_space, z as _slicedToArray } from './client.12c439e5.js';
...
function create_each_block_1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 16, 4, 477);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(16:2) {#each tags as tag}",
    ctx: ctx
  });
  return block;
} // (22:2) {#if author && author.name}
...
function create_if_block_1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 22, 4, 622);
    },
    m: function mount(target, anchor) {
      insert_dev(target, span, anchor);
      append_dev(span, t);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(22:2) {#if author && author.name}",
    ctx: ctx
  });
  return block;
} // (26:2) {#if author && author.links}
...
function create_if_block(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(26:2) {#if author && author.links}",
    ctx: ctx
  });
  return block;
} // (27:4) {#each author.links as link}
...
function create_each_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      /*link*/
      ctx[5].icon);
      add_location(i, file, 28, 8, 799);
      attr_dev(a, "href", a_href_value =
      /*link*/
      ctx[5].url);
      attr_dev(a, "target", "__blank");
      attr_dev(a, "class", "");
      add_location(a, file, 27, 6, 745);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(27:4) {#each author.links as link}",
    ctx: ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  ...
  ctx[1] &&
  /*author*/
  ctx[1].name && create_if_block_1(ctx);
  var if_block1 =
  /*author*/
  ctx[1] &&
  /*author*/
  ctx[1].links && create_if_block(ctx);
  var block = {
    c: function create() {
      div = element("div");
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-sm");
      add_location(span, file, 33, 2, 860);
      attr_dev(hr, "class", "mb-4 mt-4");
      add_location(hr, file, 34, 2, 903);
      attr_dev(div, "class", "text-gray-600");
      add_location(div, file, 14, 0, 423);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx, _ref) {
      ...
      ctx[1] &&
      /*author*/
      ctx[1].name) if_block0.p(ctx, dirty);
      if (
      /*author*/
      ctx[1] &&
      /*author*/
      ctx[1].links) if_block1.p(ctx, dirty);
    },
    i: noop,
    o: noop,
    d: function destroy(detaching) {
...
function instance($$self, $$props, $$invalidate) {
  var post = $$props.post;
  var date = new Date(getPostDate(post));
  var tags = post.data.tags ? post.data.tags : null;
  var author = post.data.author ? post.data.author : getDefaultAuthor();
  ...
  return [tags, author, shortDate, post];
}
